...
function handleIncrementAmount(event){
  ...
  return (
    <div>
        ...
        <br/>
        <br/>
        <button onClick={()=>dispatch(increment(incrementAmount))}>⬆️</button>
        <button onClick={()=>dispatch(decrement(incrementAmount))}>⬇️</button>
        <br/>
        <br/>
